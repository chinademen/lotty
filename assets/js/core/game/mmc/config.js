    ...
    var pros = {
        ...
        algorithmInjection: function() {
            ...
            switch (methodId) {
                ...
                //任选6中5复式
                case '103':
                    var result = currentMethod.combine(currentMethod.getPureDataFromBall(balls.balls[0]), 6);
                    if (result.length > 0) {
                        currentGame.doneAlgorithmInjection(result.length);
                    } else {
                        gameOrder.fireEvent('resetSelectBalls');
                ...
                //任选7中5复式
                case '104':
                    var result = currentMethod.combine(currentMethod.getPureDataFromBall(balls.balls[0]), 7);
                    if (result.length > 0) {
                        currentGame.doneAlgorithmInjection(result.length);
                    } else {
                        gameOrder.fireEvent('resetSelectBalls');
                ...
                //任选8中5复式
                case '105':
                    var result = currentMethod.combine(currentMethod.getPureDataFromBall(balls.balls[0]), 8);
                    if (result.length > 0) {
                        currentGame.doneAlgorithmInjection(result.length);
                    } else {
                        gameOrder.fireEvent('resetSelectBalls');
                ...
                //前三直选复式
                case '112':
                    var result = currentMethod.filterErrorData(currentMethod.combination2(currentMethod.getPureDataFromBall(balls.balls)));
                    if (result.length > 0) {
                        currentGame.doneAlgorithmInjection(result.length);
                    } else {
                        gameOrder.fireEvent('resetSelectBalls');
                ...
                //任选 任选八中五胆拖
                case '119':
                    if ($('.ball-section .ball-content:eq(0) .ball-number-current').size() == 0) return;
                    var result = currentMethod.combine(currentMethod.getPureDataFromBall(balls.balls[1]), 8 - $('.ball-section .ball-content:eq(0) .ball-number-current').size());
                    if (result.length > 0) {
                        currentGame.doneAlgorithmInjection(result.length);
                    } else {
                        gameOrder.fireEvent('resetSelectBalls');
                ...
                case '118':
                    if ($('.ball-section .ball-content:eq(0) .ball-number-current').size() == 0) return;
                    var result = currentMethod.combine(currentMethod.getPureDataFromBall(balls.balls[1]), 7 - $('.ball-section .ball-content:eq(0) .ball-number-current').size());
                    if (result.length > 0) {
                        currentGame.doneAlgorithmInjection(result.length);
                    } else {
                        gameOrder.fireEvent('resetSelectBalls');
                ...
                case '117':
                    if ($('.ball-section .ball-content:eq(0) .ball-number-current').size() == 0) return;
                    var result = currentMethod.combine(currentMethod.getPureDataFromBall(balls.balls[1]), 6 - $('.ball-section .ball-content:eq(0) .ball-number-current').size());
                    if (result.length > 0) {
                        currentGame.doneAlgorithmInjection(result.length);
                    } else {
                        gameOrder.fireEvent('resetSelectBalls');
                ...
                case '116':
                    if ($('.ball-section .ball-content:eq(0) .ball-number-current').size() == 0) return;
                    var result = currentMethod.combine(currentMethod.getPureDataFromBall(balls.balls[1]), 5 - $('.ball-section .ball-content:eq(0) .ball-number-current').size());
                    if (result.length > 0) {
                        currentGame.doneAlgorithmInjection(result.length);
                    } else {
                        gameOrder.fireEvent('resetSelectBalls');
                ...
                case '115':
                    if ($('.ball-section .ball-content:eq(0) .ball-number-current').size() == 0) return;
                    var result = currentMethod.combine(currentMethod.getPureDataFromBall(balls.balls[1]), 4 - $('.ball-section .ball-content:eq(0) .ball-number-current').size());
                    if (result.length > 0) {
                        currentGame.doneAlgorithmInjection(result.length);
                    } else {
                        gameOrder.fireEvent('resetSelectBalls');
                ...
                case '121':
                    if ($('.ball-section .ball-content:eq(0) .ball-number-current').size() == 0) return;
                    var result = currentMethod.combine(currentMethod.getPureDataFromBall(balls.balls[1]), 3 - $('.ball-section .ball-content:eq(0) .ball-number-current').size());
                    if (result.length > 0) {
                        currentGame.doneAlgorithmInjection(result.length);
                    } else {
                        gameOrder.fireEvent('resetSelectBalls');
                ...
                case '120':
                    if ($('.ball-section .ball-content:eq(0) .ball-number-current').size() == 0) return;
                    var result = currentMethod.combine(currentMethod.getPureDataFromBall(balls.balls[1]), 2 - $('.ball-section .ball-content:eq(0) .ball-number-current').size());
                    if (result.length > 0) {
                        currentGame.doneAlgorithmInjection(result.length);
                    } else {
                        gameOrder.fireEvent('resetSelectBalls');
