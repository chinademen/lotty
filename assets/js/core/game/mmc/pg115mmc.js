...
(function($) {
    function F(t, o) {
        this.opts = $.extend({
            ballsize: 5, // 彩球个数
            initball: '00,00,00,00,00', // 初始化彩球数据
            separator: ',',
...
(function(host, name, $, Game) {
    ...
    var pros = {
        ...
        init: function(config) {
            ...
            that.addLotteryList(43,"history");
            that.flipball();
        ...
        animateLottery: function(res) {
            ...
            var data = res.data;
            var gameMessage = Games.getCurrentMessage();
            var mmc_result = data.result.split(' ');
            //单次开奖动画
            this.flipball().flip(mmc_result, true, function() {
                //中奖金额以及中奖注数
                that.renderGamesHistory(mmc_result);
